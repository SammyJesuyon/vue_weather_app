        ...
        <nav class="container flex flex-col sm:flex-row items-center gap-4 text-white py-6">
            <RouterLink :to="{ name: 'home' }">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-2xl">My Weather Cast</p>
                </div>
            </RouterLink>
            ...
            <BaseModal :modalActive="modalActive" @close-modal="toggleModal" class="text-black">
          ...
          <ol class="list-decimal list-inside mb-4">
            ...
            <li>
              Track the city by clicking on the "+" icon at the
              top right. This will save the city so that you can view at a
